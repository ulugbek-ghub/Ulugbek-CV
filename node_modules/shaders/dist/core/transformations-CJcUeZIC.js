...
var sRGB = new RGBColorSpace({
	...
	fromBase: (rgb) => {
		return rgb.map((val) => {
			let sign$1 = val < 0 ? -1 : 1;
			let abs$1 = val * sign$1;
			if (abs$1 > .0031308) return sign$1 * (1.055 * abs$1 ** (1 / 2.4) - .055);
			return 12.92 * val;
		});
	},
	toBase: (rgb) => {
		return rgb.map((val) => {
			...
			return sign$1 * ((abs$1 + .055) / 1.055) ** 2.4;
		});
	},
	formats: {
...
function linearize(val) {
	...
	return sign$1 * Math.pow(abs$1, 2.4);
}
...
export { transformColor as a, transformEdges as c, transformBoolean as i, transformPosition as l, setColorSpaceMode as n, transformColorSpace as o, transformAngle as r, transformColorUpdate as s, colorSpaceOptions as t, transformPositionUpdate as u };
