...
const componentDefinition = {
	...
	fragmentNode: ({ uniforms }) => {
		...
		const sdf = vesicaSdf(dx.mul(cosR).add(dy.mul(sinR)), dy.mul(cosR).sub(dx.mul(sinR)), uniforms.radius.uniform, uniforms.spread.uniform);
...
export { componentDefinition as n, Vesica_default as t };
