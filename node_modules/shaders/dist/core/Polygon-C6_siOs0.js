...
const componentDefinition = {
	...
	fragmentNode: ({ uniforms }) => {
		...
		const sdf = mix(polygonSdf(rdx, rdy, radius, uniforms.sides.uniform), circleSdf(dx, dy, radius), uniforms.rounding.uniform);
...
export { componentDefinition as n, Polygon_default as t };
