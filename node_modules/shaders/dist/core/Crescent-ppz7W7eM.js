...
import { i as crescentSdf } from "./sdf-D_EAGXhN.js";
...
const componentDefinition = {
	...
	fragmentNode: ({ uniforms }) => {
		...
		const sdf = crescentSdf(dx.mul(cosR).add(dy.mul(sinR)), dy.mul(cosR).sub(dx.mul(sinR)), uniforms.radius.uniform, uniforms.innerRatio.uniform, uniforms.offset.uniform);
...
export { componentDefinition as n, Crescent_default as t };
