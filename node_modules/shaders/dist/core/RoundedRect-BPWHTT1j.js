...
const componentDefinition = {
	...
	fragmentNode: ({ uniforms }) => {
		...
		const sdf = roundedRectSdf(dx.mul(cosR).add(dy.mul(sinR)), dy.mul(cosR).sub(dx.mul(sinR)), uniforms.width.uniform, uniforms.height.uniform, uniforms.rounding.uniform);
...
export { componentDefinition as n, RoundedRect_default as t };
