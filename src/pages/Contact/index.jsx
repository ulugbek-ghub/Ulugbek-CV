        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
          <div className="space-y-8">
            <div>
              ...
              <a href="mailto:ulugbek@email.com" className="text-[14px] text-[var(--text-secondary)] no-underline transition-colors duration-200 hover:text-[var(--text)] font-[family-name:var(--font-body)]">
                ulugbek@email.com
              </a>
            </div>
            <div>
              <p className="text-[11px] uppercase tracking-[0.15em] text-[var(--text-dim)] mb-2 font-[family-name:var(--font-body)]">Phone</p>
              <a href="tel:+998-93-742-2333" className="text-[14px] text-[var(--text-secondary)] no-underline transition-colors duration-200 hover:text-[var(--text)] font-[family-name:var(--font-body)]">
                +998 93 742 23 33
              </a>
            </div>
            <div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <a href="https://github.com/ulugbek-ghub" target="_blank" className="text-[14px] text-[var(--text-secondary)] no-underline transition-colors duration-200 hover:text-[var(--text)] font-[family-name:var(--font-body)]">
                @ulugbek-ghub
              </a>
            </div>
            <div>
              <p className="text-[11px] uppercase tracking-[0.15em] text-[var(--text-dim)] mb-2 font-[family-name:var(--font-body)]">Instagram</p>
              <a href="https://www.instagram.com/ulugbekk.s/" target="_blank" className="text-[14px] text-[var(--text-secondary)] no-underline transition-colors duration-200 hover:text-[var(--text)] font-[family-name:var(--font-body)]">
                @ulugbekk.s
              </a>
            </div>
          </div>
